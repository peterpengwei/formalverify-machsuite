...
wire   [7:0] tmp_24_fu_560_p2;
reg   [7:0] tmp_24_reg_881;
wire   [4:0] k_addr_5_reg_891;
wire   [4:0] k_addr_7_reg_901;
wire   [7:0] tmp_26_fu_588_p2;
reg   [7:0] tmp_26_reg_906;
wire    ap_CS_fsm_state5;
wire   [7:0] tmp_28_fu_594_p2;
reg   [7:0] tmp_28_reg_911;
wire   [7:0] tmp_31_fu_622_p2;
reg   [7:0] tmp_31_reg_916;
...
wire   [63:0] tmp_23_fu_550_p1;
wire   [63:0] tmp_fu_555_p1;
wire   [63:0] tmp_25_fu_566_p1;
wire   [63:0] tmp_27_fu_571_p1;
wire   [63:0] tmp_34_fu_646_p1;
wire   [63:0] tmp_35_fu_651_p1;
wire   [63:0] tmp_38_fu_661_p1;
wire   [63:0] tmp_40_fu_671_p1;
wire   [63:0] tmp_43_fu_681_p1;
wire   [63:0] tmp_45_fu_691_p1;
wire   [63:0] tmp_48_fu_701_p1;
wire   [63:0] tmp_50_fu_711_p1;
wire   [63:0] tmp_52_fu_722_p1;
wire   [63:0] tmp_54_fu_727_p1;
wire   [63:0] tmp_56_fu_732_p1;
wire   [63:0] tmp_58_fu_737_p1;
wire   [63:0] tmp_62_fu_760_p1;
wire   [63:0] tmp_63_fu_765_p1;
wire   [63:0] tmp_66_fu_775_p1;
wire   [63:0] tmp_68_fu_785_p1;
wire   [63:0] tmp_71_fu_795_p1;
wire   [63:0] tmp_73_fu_805_p1;
wire   [63:0] tmp_76_fu_815_p1;
wire   [63:0] tmp_78_fu_825_p1;
wire   [7:0] tmp_s_fu_581_p2;
wire   [7:0] tmp1_fu_575_p2;
wire   [0:0] tmp_30_fu_606_p3;
wire   [7:0] tmp_35_cast_cast_fu_614_p3;
wire   [7:0] tmp_29_fu_600_p2;
wire   [3:0] tmp_33_fu_640_p2;
wire   [3:0] tmp_37_fu_656_p2;
wire   [3:0] tmp_39_fu_666_p2;
wire   [3:0] tmp_42_fu_676_p2;
wire   [3:0] tmp_44_fu_686_p2;
wire   [3:0] tmp_47_fu_696_p2;
wire   [3:0] tmp_49_fu_706_p2;
wire   [4:0] tmp_61_fu_754_p2;
wire   [4:0] tmp_65_fu_770_p2;
wire   [4:0] tmp_67_fu_780_p2;
wire   [4:0] tmp_70_fu_790_p2;
wire   [4:0] tmp_72_fu_800_p2;
wire   [4:0] tmp_75_fu_810_p2;
wire   [4:0] tmp_77_fu_820_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        k_addr_11_reg_949[3 : 1] <= tmp_40_fu_671_p1[3 : 1];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        k_addr_13_reg_959[0] <= tmp_45_fu_691_p1[0];
k_addr_13_reg_959[3 : 2] <= tmp_45_fu_691_p1[3 : 2];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        k_addr_15_reg_970[3 : 2] <= tmp_50_fu_711_p1[3 : 2];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_80_fu_742_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state19))) begin
        k_addr_25_reg_1058 <= tmp_63_fu_765_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state20)) begin
        k_addr_27_reg_1069[4 : 1] <= tmp_68_fu_785_p1[4 : 1];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state21)) begin
        k_addr_29_reg_1079[0] <= tmp_73_fu_805_p1[0];
k_addr_29_reg_1079[4 : 2] <= tmp_73_fu_805_p1[4 : 2];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state22)) begin
        k_addr_31_reg_1090[4 : 2] <= tmp_78_fu_825_p1[4 : 2];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_32_fu_628_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
        k_addr_9_reg_938 <= tmp_35_fu_651_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        tmp_24_reg_881 <= tmp_24_fu_560_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        tmp_26_reg_906 <= tmp_26_fu_588_p2;
        tmp_28_reg_911 <= tmp_28_fu_594_p2;
        tmp_31_reg_916 <= tmp_31_fu_622_p2;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state24)) begin
        ...
        k_address0 = tmp_76_fu_815_p1;
    end else if ((1'b1 == ap_CS_fsm_state21)) begin
        k_address0 = tmp_71_fu_795_p1;
    end else if ((1'b1 == ap_CS_fsm_state20)) begin
        k_address0 = tmp_66_fu_775_p1;
    end else if ((1'b1 == ap_CS_fsm_state19)) begin
        k_address0 = tmp_62_fu_760_p1;
    end else if ((1'b1 == ap_CS_fsm_state18)) begin
        ...
        k_address0 = tmp_48_fu_701_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        k_address0 = tmp_43_fu_681_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        k_address0 = tmp_38_fu_661_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state24)) begin
        ...
        k_address1 = tmp_78_fu_825_p1;
    end else if ((1'b1 == ap_CS_fsm_state21)) begin
        k_address1 = tmp_73_fu_805_p1;
    end else if ((1'b1 == ap_CS_fsm_state20)) begin
        k_address1 = tmp_68_fu_785_p1;
    end else if ((1'b1 == ap_CS_fsm_state19)) begin
        k_address1 = tmp_63_fu_765_p1;
    end else if ((1'b1 == ap_CS_fsm_state18)) begin
        ...
        k_address1 = tmp_50_fu_711_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        k_address1 = tmp_45_fu_691_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        k_address1 = tmp_40_fu_671_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        k_address1 = tmp_35_fu_651_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state16)) begin
        ...
        sbox_address0 = tmp_52_fu_722_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        sbox_address0 = tmp_fu_555_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        sbox_address0 = tmp_23_fu_550_p1;
    end else begin
        sbox_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state16)) begin
        ...
        sbox_address1 = tmp_25_fu_566_p1;
    end else begin
        sbox_address1 = 'bx;
    end
end
...
assign ap_return = tmp_31_reg_916;
...
assign sbox_address2 = tmp_27_fu_571_p1;

assign tmp1_fu_575_p2 = (reg_515 ^ rc_read);

assign tmp_23_fu_550_p1 = reg_519;

assign tmp_24_fu_560_p2 = (sbox_q0 ^ k_q1);

assign tmp_25_fu_566_p1 = reg_519;

assign tmp_26_fu_588_p2 = (sbox_q1 ^ k_q0);

assign tmp_27_fu_571_p1 = k_load_6_reg_871;

assign tmp_28_fu_594_p2 = (sbox_q2 ^ k_q1);

assign tmp_29_fu_600_p2 = rc_read << 8'd1;

assign tmp_30_fu_606_p3 = rc_read[32'd7];

assign tmp_31_fu_622_p2 = (tmp_35_cast_cast_fu_614_p3 ^ tmp_29_fu_600_p2);

assign tmp_32_fu_628_p3 = i_reg_473[32'd4];

assign tmp_33_fu_640_p2 = ($signed(4'd12) + $signed(tmp_60_fu_636_p1));

assign tmp_34_fu_646_p1 = tmp_33_fu_640_p2;

assign tmp_35_cast_cast_fu_614_p3 = ((tmp_30_fu_606_p3[0:0] === 1'b1) ? 8'd27 : 8'd0);

assign tmp_35_fu_651_p1 = i_reg_473;

assign tmp_37_fu_656_p2 = ($signed(4'd13) + $signed(tmp_60_reg_923));

assign tmp_38_fu_661_p1 = tmp_37_fu_656_p2;

assign tmp_39_fu_666_p2 = (tmp_60_reg_923 | 4'd1);

assign tmp_40_fu_671_p1 = tmp_39_fu_666_p2;

assign tmp_42_fu_676_p2 = ($signed(4'd14) + $signed(tmp_60_reg_923));

assign tmp_43_fu_681_p1 = tmp_42_fu_676_p2;

assign tmp_44_fu_686_p2 = (tmp_60_reg_923 | 4'd2);

assign tmp_45_fu_691_p1 = tmp_44_fu_686_p2;

assign tmp_47_fu_696_p2 = ($signed(4'd15) + $signed(tmp_60_reg_923));

assign tmp_48_fu_701_p1 = tmp_47_fu_696_p2;

assign tmp_49_fu_706_p2 = (tmp_60_reg_923 | 4'd3);

assign tmp_50_fu_711_p1 = tmp_49_fu_706_p2;

assign tmp_52_fu_722_p1 = reg_515;
...
assign tmp_61_fu_754_p2 = ($signed(5'd28) + $signed(tmp_81_fu_750_p1));

assign tmp_62_fu_760_p1 = tmp_61_fu_754_p2;

assign tmp_63_fu_765_p1 = i_1_reg_485;

assign tmp_65_fu_770_p2 = ($signed(5'd29) + $signed(tmp_81_reg_1043));

assign tmp_66_fu_775_p1 = tmp_65_fu_770_p2;

assign tmp_67_fu_780_p2 = (tmp_81_reg_1043 | 5'd1);

assign tmp_68_fu_785_p1 = tmp_67_fu_780_p2;

assign tmp_70_fu_790_p2 = ($signed(5'd30) + $signed(tmp_81_reg_1043));

assign tmp_71_fu_795_p1 = tmp_70_fu_790_p2;

assign tmp_72_fu_800_p2 = (tmp_81_reg_1043 | 5'd2);

assign tmp_73_fu_805_p1 = tmp_72_fu_800_p2;

assign tmp_75_fu_810_p2 = ($signed(5'd31) + $signed(tmp_81_reg_1043));

assign tmp_76_fu_815_p1 = tmp_75_fu_810_p2;

assign tmp_77_fu_820_p2 = (tmp_81_reg_1043 | 5'd3);

assign tmp_78_fu_825_p1 = tmp_77_fu_820_p2;

assign tmp_80_fu_742_p3 = i_1_reg_485[32'd5];
