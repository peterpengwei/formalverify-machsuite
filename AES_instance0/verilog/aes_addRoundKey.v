...
reg   [4:0] i_reg_77;
wire   [4:0] tmp_71_fu_88_p1;
reg   [4:0] tmp_71_reg_141;
wire   [12:0] sum_cast_fu_92_p1;
reg   [12:0] sum_cast_reg_146;
...
wire   [12:0] tmp_cast1_fu_112_p1;
wire   [12:0] sum1_fu_121_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_CS_fsm_state1 == 1'd1) & ~(1'b0 == ap_start))) begin
        sum_cast_reg_146[11 : 0] <= sum_cast_fu_92_p1[11 : 0];
        tmp_71_reg_141 <= tmp_71_fu_88_p1;
    end
end
...
assign sum4_fu_116_p2 = (i_4_fu_102_p2 + tmp_71_reg_141);

assign sum_cast_fu_92_p1 = sum;

assign tmp_71_fu_88_p1 = key_offset[4:0];
