...
wire   [7:0] tmp_27_fu_588_p2;
reg   [7:0] tmp_27_reg_885;
wire   [3:0] tmp_58_fu_602_p1;
reg   [3:0] tmp_58_reg_892;
wire   [0:0] ap_CS_fsm_state7;
wire   [0:0] tmp_28_fu_594_p3;
reg   [4:0] k_addr_9_reg_907;
wire   [4:0] i_2_fu_622_p2;
reg   [4:0] i_2_reg_913;
reg   [4:0] k_addr_11_reg_923;
reg   [7:0] tmp_40_reg_928;
wire   [0:0] ap_CS_fsm_state9;
reg   [4:0] k_addr_13_reg_938;
reg   [7:0] tmp_45_reg_944;
...
wire   [4:0] tmp_79_fu_716_p1;
reg   [4:0] tmp_79_reg_1022;
wire   [0:0] ap_CS_fsm_state19;
wire   [0:0] tmp_59_fu_708_p3;
reg   [4:0] k_addr_25_reg_1032;
reg   [4:0] k_addr_27_reg_1037;
wire   [5:0] i_3_fu_736_p2;
reg   [5:0] i_3_reg_1042;
wire   [4:0] tmp_60_fu_742_p2;
reg   [4:0] tmp_60_reg_1047;
wire   [4:0] tmp_64_fu_747_p2;
reg   [4:0] tmp_64_reg_1052;
reg   [4:0] k_addr_29_reg_1057;
reg   [4:0] k_addr_31_reg_1062;
wire   [0:0] ap_CS_fsm_state21;
wire   [4:0] tmp_69_fu_780_p2;
reg   [4:0] tmp_69_reg_1077;
reg   [7:0] k_load_29_reg_1082;
wire   [4:0] tmp_74_fu_785_p2;
reg   [4:0] tmp_74_reg_1087;
reg   [7:0] k_load_31_reg_1092;
wire   [7:0] tmp_63_fu_790_p2;
reg   [7:0] tmp_63_reg_1097;
wire   [0:0] ap_CS_fsm_state22;
wire   [7:0] tmp_68_fu_796_p2;
reg   [7:0] tmp_68_reg_1102;
wire   [7:0] tmp_73_fu_810_p2;
reg   [7:0] tmp_73_reg_1117;
wire   [0:0] ap_CS_fsm_state23;
wire   [7:0] tmp_78_fu_815_p2;
reg   [7:0] tmp_78_reg_1122;
reg   [4:0] i_reg_470;
...
wire   [63:0] tmp_19_fu_539_p1;
wire   [63:0] tmp_21_fu_544_p1;
wire   [63:0] tmp_23_fu_549_p1;
wire   [63:0] tmp_32_fu_612_p1;
wire   [63:0] tmp_33_fu_617_p1;
wire   [63:0] tmp_37_fu_633_p1;
wire   [63:0] tmp_39_fu_643_p1;
wire   [63:0] tmp_42_fu_653_p1;
wire   [63:0] tmp_44_fu_663_p1;
wire   [63:0] tmp_47_fu_673_p1;
wire   [63:0] tmp_49_fu_683_p1;
wire   [63:0] tmp_29_fu_688_p1;
wire   [63:0] tmp_52_fu_693_p1;
wire   [63:0] tmp_54_fu_698_p1;
wire   [63:0] tmp_56_fu_703_p1;
wire   [63:0] tmp_62_fu_720_p1;
wire   [63:0] tmp_67_fu_731_p1;
wire   [63:0] tmp_72_fu_757_p1;
wire   [63:0] tmp_77_fu_767_p1;
wire   [63:0] tmp_61_fu_772_p1;
wire   [63:0] tmp_65_fu_776_p1;
wire   [63:0] tmp_70_fu_802_p1;
wire   [63:0] tmp_75_fu_806_p1;
wire   [7:0] tmp_s_fu_560_p2;
wire   [7:0] tmp1_fu_554_p2;
wire   [0:0] tmp_26_fu_572_p3;
wire   [7:0] tmp_43_cast_cast_fu_580_p3;
wire   [7:0] tmp_25_fu_566_p2;
wire   [3:0] tmp_31_fu_606_p2;
wire   [3:0] tmp_36_fu_628_p2;
wire   [3:0] tmp_38_fu_638_p2;
wire   [3:0] tmp_41_fu_648_p2;
wire   [3:0] tmp_43_fu_658_p2;
wire   [3:0] tmp_46_fu_668_p2;
wire   [3:0] tmp_48_fu_678_p2;
wire   [4:0] tmp_66_fu_725_p2;
wire   [4:0] tmp_71_fu_752_p2;
wire   [4:0] tmp_76_fu_762_p2;
...
always @ (posedge ap_clk) begin
    if (((1'd1 == ap_CS_fsm_state7) & (tmp_28_fu_594_p3 == 1'd0))) begin
        i_2_reg_913 <= i_2_fu_622_p2;
        k_addr_9_reg_907 <= tmp_33_fu_617_p1;
        tmp_58_reg_892 <= tmp_58_fu_602_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'd1 == ap_CS_fsm_state19) & (1'd0 == tmp_59_fu_708_p3))) begin
        i_3_reg_1042 <= i_3_fu_736_p2;
        k_addr_25_reg_1032 <= tmp_62_fu_720_p1;
        k_addr_27_reg_1037[4 : 1] <= tmp_67_fu_731_p1[4 : 1];
        tmp_79_reg_1022 <= tmp_79_fu_716_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'd1 == ap_CS_fsm_state8)) begin
        k_addr_11_reg_923[3 : 1] <= tmp_39_fu_643_p1[3 : 1];
    end
end

always @ (posedge ap_clk) begin
    if ((1'd1 == ap_CS_fsm_state9)) begin
        k_addr_13_reg_938[0] <= tmp_44_fu_663_p1[0];
k_addr_13_reg_938[3 : 2] <= tmp_44_fu_663_p1[3 : 2];
        tmp_40_reg_928 <= grp_fu_504_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'd1 == ap_CS_fsm_state10)) begin
        k_addr_15_reg_954[3 : 2] <= tmp_49_fu_683_p1[3 : 2];
        tmp_45_reg_944 <= grp_fu_504_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'd1 == ap_CS_fsm_state20)) begin
        k_addr_29_reg_1057[0] <= tmp_72_fu_757_p1[0];
k_addr_29_reg_1057[4 : 2] <= tmp_72_fu_757_p1[4 : 2];
        k_addr_31_reg_1062[4 : 2] <= tmp_77_fu_767_p1[4 : 2];
        tmp_60_reg_1047 <= tmp_60_fu_742_p2;
        tmp_64_reg_1052 <= tmp_64_fu_747_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'd1 == ap_CS_fsm_state21)) begin
        ...
        tmp_69_reg_1077 <= tmp_69_fu_780_p2;
        tmp_74_reg_1087 <= tmp_74_fu_785_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'd1 == ap_CS_fsm_state5)) begin
        tmp_27_reg_885 <= tmp_27_fu_588_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'd1 == ap_CS_fsm_state22)) begin
        tmp_63_reg_1097 <= tmp_63_fu_790_p2;
        tmp_68_reg_1102 <= tmp_68_fu_796_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'd1 == ap_CS_fsm_state23)) begin
        tmp_73_reg_1117 <= tmp_73_fu_810_p2;
        tmp_78_reg_1122 <= tmp_78_fu_815_p2;
    end
end
...
always @ (*) begin
    if ((1'd1 == ap_CS_fsm_state24)) begin
        ...
        k_address1 = tmp_75_fu_806_p1;
    end else if ((1'd1 == ap_CS_fsm_state21)) begin
        k_address1 = tmp_65_fu_776_p1;
    end else if ((1'd1 == ap_CS_fsm_state20)) begin
        k_address1 = tmp_77_fu_767_p1;
    end else if ((1'd1 == ap_CS_fsm_state19)) begin
        k_address1 = tmp_67_fu_731_p1;
    end else if ((1'd1 == ap_CS_fsm_state18)) begin
        ...
        k_address1 = tmp_49_fu_683_p1;
    end else if ((1'd1 == ap_CS_fsm_state9)) begin
        k_address1 = tmp_44_fu_663_p1;
    end else if ((1'd1 == ap_CS_fsm_state8)) begin
        k_address1 = tmp_39_fu_643_p1;
    end else if ((1'd1 == ap_CS_fsm_state7)) begin
        k_address1 = tmp_33_fu_617_p1;
    end else if ((1'd1 == ap_CS_fsm_state6)) begin
...
always @ (*) begin
    if ((1'd1 == ap_CS_fsm_state24)) begin
        k_d0 = tmp_73_reg_1117;
    end else if ((1'd1 == ap_CS_fsm_state23)) begin
        k_d0 = tmp_63_reg_1097;
    end else if ((1'd1 == ap_CS_fsm_state12)) begin
        k_d0 = tmp_45_reg_944;
    end else if ((1'd1 == ap_CS_fsm_state11)) begin
        k_d0 = reg_528;
...
always @ (*) begin
    if ((1'd1 == ap_CS_fsm_state24)) begin
        k_d1 = tmp_78_reg_1122;
    end else if ((1'd1 == ap_CS_fsm_state23)) begin
        k_d1 = tmp_68_reg_1102;
    end else if ((1'd1 == ap_CS_fsm_state12)) begin
        k_d1 = reg_528;
    end else if ((1'd1 == ap_CS_fsm_state11)) begin
        k_d1 = tmp_40_reg_928;
...
always @ (*) begin
    if ((1'd1 == ap_CS_fsm_state16)) begin
        sbox_address0 = tmp_54_fu_698_p1;
    end else if ((1'd1 == ap_CS_fsm_state15)) begin
        sbox_address0 = tmp_29_fu_688_p1;
    end else if ((1'd1 == ap_CS_fsm_state4)) begin
        sbox_address0 = tmp_21_fu_544_p1;
    end else if ((1'd1 == ap_CS_fsm_state3)) begin
...
always @ (*) begin
    if ((1'd1 == ap_CS_fsm_state16)) begin
        sbox_address1 = tmp_56_fu_703_p1;
    end else if ((1'd1 == ap_CS_fsm_state15)) begin
        sbox_address1 = tmp_52_fu_693_p1;
    end else if ((1'd1 == ap_CS_fsm_state4)) begin
        sbox_address1 = tmp_23_fu_549_p1;
    end else if ((1'd1 == ap_CS_fsm_state3)) begin
        sbox_address1 = tmp_19_fu_539_p1;
    end else begin
        sbox_address1 = 'bx;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        25'd64 : begin
            if ((tmp_28_fu_594_p3 == 1'd0)) begin
                ap_NS_fsm = 25'd128;
            end else begin
                ap_NS_fsm = 25'd4096;
            end
        ...
        25'd262144 : begin
            if ((1'd0 == tmp_59_fu_708_p3)) begin
...
assign ap_return = tmp_27_reg_885;
...
assign tmp_19_fu_539_p1 = reg_514;

assign tmp_21_fu_544_p1 = reg_510;

assign tmp_23_fu_549_p1 = reg_514;

assign tmp_25_fu_566_p2 = rc_read << 8'd1;

assign tmp_26_fu_572_p3 = rc_read[32'd7];

assign tmp_27_fu_588_p2 = (tmp_43_cast_cast_fu_580_p3 ^ tmp_25_fu_566_p2);

assign tmp_28_fu_594_p3 = i_reg_470[32'd4];

assign tmp_29_fu_688_p1 = reg_510;

assign tmp_31_fu_606_p2 = ($signed(4'd12) + $signed(tmp_58_fu_602_p1));

assign tmp_32_fu_612_p1 = tmp_31_fu_606_p2;

assign tmp_33_fu_617_p1 = i_reg_470;

assign tmp_36_fu_628_p2 = ($signed(4'd13) + $signed(tmp_58_reg_892));

assign tmp_37_fu_633_p1 = tmp_36_fu_628_p2;

assign tmp_38_fu_638_p2 = (tmp_58_reg_892 | 4'd1);

assign tmp_39_fu_643_p1 = tmp_38_fu_638_p2;

assign tmp_41_fu_648_p2 = ($signed(4'd14) + $signed(tmp_58_reg_892));

assign tmp_42_fu_653_p1 = tmp_41_fu_648_p2;

assign tmp_43_cast_cast_fu_580_p3 = ((tmp_26_fu_572_p3[0:0] === 1'b1) ? 8'd27 : 8'd0);

assign tmp_43_fu_658_p2 = (tmp_58_reg_892 | 4'd2);

assign tmp_44_fu_663_p1 = tmp_43_fu_658_p2;

assign tmp_46_fu_668_p2 = ($signed(4'd15) + $signed(tmp_58_reg_892));

assign tmp_47_fu_673_p1 = tmp_46_fu_668_p2;

assign tmp_48_fu_678_p2 = (tmp_58_reg_892 | 4'd3);

assign tmp_49_fu_683_p1 = tmp_48_fu_678_p2;

assign tmp_52_fu_693_p1 = reg_514;

assign tmp_54_fu_698_p1 = reg_510;

assign tmp_56_fu_703_p1 = reg_514;

assign tmp_58_fu_602_p1 = i_reg_470[3:0];

assign tmp_59_fu_708_p3 = i_1_reg_481[32'd5];

assign tmp_60_fu_742_p2 = ($signed(5'd28) + $signed(tmp_79_reg_1022));

assign tmp_61_fu_772_p1 = tmp_60_reg_1047;

assign tmp_62_fu_720_p1 = i_1_reg_481;

assign tmp_63_fu_790_p2 = (reg_510 ^ k_q0);

assign tmp_64_fu_747_p2 = ($signed(5'd29) + $signed(tmp_79_reg_1022));

assign tmp_65_fu_776_p1 = tmp_64_reg_1052;

assign tmp_66_fu_725_p2 = (tmp_79_fu_716_p1 | 5'd1);

assign tmp_67_fu_731_p1 = tmp_66_fu_725_p2;

assign tmp_68_fu_796_p2 = (reg_514 ^ k_q1);

assign tmp_69_fu_780_p2 = ($signed(5'd30) + $signed(tmp_79_reg_1022));

assign tmp_70_fu_802_p1 = tmp_69_reg_1077;

assign tmp_71_fu_752_p2 = (tmp_79_reg_1022 | 5'd2);

assign tmp_72_fu_757_p1 = tmp_71_fu_752_p2;

assign tmp_73_fu_810_p2 = (k_load_29_reg_1082 ^ k_q0);

assign tmp_74_fu_785_p2 = ($signed(5'd31) + $signed(tmp_79_reg_1022));

assign tmp_75_fu_806_p1 = tmp_74_reg_1087;

assign tmp_76_fu_762_p2 = (tmp_79_reg_1022 | 5'd3);

assign tmp_77_fu_767_p1 = tmp_76_fu_762_p2;

assign tmp_78_fu_815_p2 = (k_load_31_reg_1092 ^ k_q1);

assign tmp_79_fu_716_p1 = i_1_reg_481[4:0];
